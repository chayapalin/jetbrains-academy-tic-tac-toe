...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        printBoard(); // print the empty field
    ...
    public static void createBoard() {
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < m; j++) {
                gameBoard[i][j] = ' '; // initialize each cell with a space
            }
        }
    }
    ...
    public static void enterCoordinates() { // Analyze user input and show these messages in the following situations:
